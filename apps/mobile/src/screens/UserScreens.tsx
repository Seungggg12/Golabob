...
export function MyReservationsScreen({ reservations, onOpenRestaurant, onCancel, onReview }: { reservations: Reservation[]; onOpenRestaurant: (reservation: Reservation) => void; onCancel: (reservation: Reservation) => void | Promise<void>; onReview: (reservation: Reservation) => void }) {
